...
%% Alokacja wektorów
% Trajektora zadana na całym horyzoncie symulacji
...
% Przyrosty sterowań
detu = zeros(2*Hs,1);
% Niemierzealne zakłócenia i niedokładności
d_h = zeros(kend,1);
d_pH = zeros(kend,1);
% Sterowania procesu
q1(1:kstart-1) = q10;
...
% Dodatkowe sygnały na potrzeby symulacji modelu
v_h(1:kstart-1) = 0;
v_pH(1:kstart-1) = 0;
v_h0(1:Hp) = 0;
v_pH0(1:Hp) = 0;
...
for k = kstart:kend
    ...
    % -------------------------------------- Inne obliczenia    
    % Niedokładności i niepewności pomiaru
